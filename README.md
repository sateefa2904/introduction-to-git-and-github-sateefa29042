...
2.  - [Git and GitHub Tutorial for Beginners](https://www.youtube.com/watch?v=tRZGeaHPoaw)
    - [Using Git with Visual Studio Code](https://www.youtube.com/watch?v=i_23KUAEtUM)


## 📝 Tasks and Grading Rubric

* 50pts - Complete the branching tutorial at: [Learn Git Branching] (https://learngitbranching.js.org/)
...
* 10pts - Edit the C file to print your name and NetID .  
        - Print "Complete." on a new line. Print it exactly as requested.
